...
import { Sandbox, SandboxAccount, OperationalLog, SystemAlert, Theme, ViewState } from '../types';
  ...
  return (
    <div className="p-6 space-y-6 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-xl border flex items-center justify-between bg-app-card border-app-border text-app-text-main hover:bg-app-bg/50 transition-all">
          <div className="space-y-1">
            <span className="text-[10px] font-bold text-app-text-muted uppercase tracking-wider">Open Orders</span>
            <p className="text-xl font-bold">{openOrderCount} Orders</p>
            <p className="text-[10px] text-app-text-muted">Loaded from backend monitor snapshots</p>
          </div>
          <div className="p-2.5 rounded-lg bg-app-accent/10 text-app-accent">
            <Activity size={18} />
          </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="border rounded-xl p-4 space-y-3 bg-app-card border-app-border text-app-text-main">
            ...
            <div className="pt-2 flex items-center space-x-2 text-[11px] text-app-text-muted border-t border-app-border">
              ...
              <span>Replay playback state is loaded from backend sandbox snapshots.</span>
            </div>
          </div>
        </div>
