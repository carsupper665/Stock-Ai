<template>
  <span class="badge" :class="badgeClass"><slot>{{ displayLabel }}</slot></span>
</template>

<script setup lang="ts">
import { computed } from 'vue'
import { formatStatusLabel } from '@/utils/localization'
...
const displayLabel = computed(() => formatStatusLabel(props.label))
</script>
