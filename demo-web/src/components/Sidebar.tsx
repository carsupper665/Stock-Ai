...
export default function Sidebar({
  ...
  const groups = [
    ...
    },
    {
      ...
      items: [
        { id: 'sandboxes' as ActivePage, label: 'Sandboxes Control', icon: Box, badge: sandboxCount > 0 ? String(sandboxCount) : undefined },
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="text-[11px]">
              ...
              <p className="text-[9px] text-app-text-muted">
                {isLoggedIn ? 'Full Controls' : 'Simulated Lock'}
              </p>
            </div>
          </div>
          <button
            ...
            title={isLoggedIn ? 'Lock Console' : 'Access Unlocked'}
          >
